...
export default function ApartmentCard({ apartment }: { apartment: Apartment }) {
  ...
  return (
    <Link
      ...
      className="focus-ring group block overflow-hidden rounded-2xl bg-ivory shadow-card transition hover:-translate-y-1"
    >
      ...
      <div className="p-5">
        ...
        <span className="mt-5 inline-block text-sm font-medium text-clayDeep group-hover:underline">
