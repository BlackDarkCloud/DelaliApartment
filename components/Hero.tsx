    ...
    <section className="px-3 pt-3 sm:px-6 sm:pt-6">
      <div className="relative isolate mx-auto min-h-[640px] w-full max-w-[1400px] overflow-hidden rounded-[28px] sm:min-h-[720px] sm:rounded-[36px]">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-night/55 via-night/10 to-night/70" />
        <div className="absolute inset-0 bg-gradient-to-r from-night/50 via-transparent to-transparent" />
