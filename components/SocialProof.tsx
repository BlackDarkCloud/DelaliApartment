        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            <a
              ...
              aria-hidden="true"
              tabIndex={-1}
              className="focus-ring flex h-10 w-10 items-center justify-center rounded-full border border-night/20 text-night/60 transition hover:border-night/50 hover:text-night"
            >
              <ArrowLeft size={16} />
            </a>
            <a
